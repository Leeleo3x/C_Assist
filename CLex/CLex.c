...
void CLexAnalyser(const char * file, struct normalNode ** nHead, struct errorNode ** eHead, struct identifierNode ** iHead)
{
    styleMark = 100;
    initialize();
    scanner(file);
...
/*     struct identifierNode * iHead; */

/*     char str[] = "../leo.c"; */
/*     CLexAnalyser(str, &nHead, &eHead, &iHead); */
/*     printf("%d\n", leftBig); */
/*     printf("%d\n", rightBig); */
